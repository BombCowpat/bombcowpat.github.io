;(function () {
  ...
  fabric.StaticCanvas = fabric.util.createClass(
    ...
    /** @lends fabric.StaticCanvas.prototype */ {
       ...
       * fabric.Image.fromURL('https://bombcowpat.github.io/assets/jail_cell_bars.png', function(img, isError) {
       ...
       * fabric.Image.fromURL('https://bombcowpat.github.io/assets/honey_im_subtle.png', function(img, isError) {
       *    img.set({width: canvas.width, height: canvas.height, originX: 'left', originY: 'top'});
